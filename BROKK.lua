...
function CleangGroups();local z = io.open('./BROK');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/BROKK.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
os.execute('rm -rf BROKK.lua')
os.execute('rm -rf start.lua')
download_to_file('https://raw.githubusercontent.com/teamzbrok/BROKK/master/BROKK.lua', 'BROKK.lua') 
download_to_file('https://raw.githubusercontent.com/teamzbrok/BROKK/master/start.lua', 'start.lua') 
dofile('BROKK.lua')  
return false
end
...
if DevBROK(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/teamzbrok/files_BROK/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/teamzbrok/files_BROK/master/files_BROK/"..file)
if res == 200 then
